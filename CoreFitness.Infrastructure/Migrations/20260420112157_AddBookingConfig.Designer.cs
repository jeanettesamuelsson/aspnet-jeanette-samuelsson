...
namespace CoreFitness.Infrastructure.Migrations
{
    ...
    [Migration("20260420112157_AddBookingConfig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreFitness.Infrastructure.Persistence.Entities.BookingEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CoreFitness.Infrastructure.Persistence.Entities.GymClassEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CoreFitness.Infrastructure.Persistence.Entities.MemberEntity", b =>
                {
                    ...
                    b.Property<string>("CurrentMembershipId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CurrentMembershipId");
            ...
            modelBuilder.Entity("CoreFitness.Infrastructure.Persistence.Entities.BookingEntity", b =>
                {
                    b.HasOne("CoreFitness.Infrastructure.Persistence.Entities.GymClassEntity", "GymClass")
                        .WithMany()
                        .HasForeignKey("GymClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoreFitness.Infrastructure.Persistence.Entities.MemberEntity", "Member")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreFitness.Infrastructure.Persistence.Entities.MemberEntity", b =>
                {
                    b.HasOne("CoreFitness.Infrastructure.Persistence.Entities.MembershipEntity", "CurrentMembership")
                        .WithMany()
                        .HasForeignKey("CurrentMembershipId")
